...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("-m", "--led-gpio-mapping", help="Hardware Mapping: regular, adafruit-hat, adafruit-hat-pwm" , choices=['applicon', 'regular', 'adafruit-hat', 'adafruit-hat-pwm'], type=str)
